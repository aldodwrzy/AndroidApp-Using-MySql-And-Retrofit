...
public class EditorActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_delete:
                ...
                dialog.setMessage("Delete this person?");
    ...
    private void postData(final String key) {
        ...
        Call<Mahasiswa> call = apiInterface.insertPet(key, name, species, breed, gender, birth, picture);
    ...
    private void updateData(final String key, final int id) {
        ...
        Call<Mahasiswa> call = apiInterface.updatePet(key, id,name, species, breed, gender, birth, picture);
    ...
    private void deleteData(final String key, final int id, final String pic) {
        ...
        Call<Mahasiswa> call = apiInterface.deletePet(key, id, pic);
